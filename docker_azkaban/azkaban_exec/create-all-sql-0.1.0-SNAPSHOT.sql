...
CREATE INDEX idx_ramp
    ON ramp (rampId);
CREATE TABLE IF NOT EXISTS ramp_dependency (
...
CREATE TABLE IF NOT EXISTS ramp_exceptional_flow_items (
    rampId VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ramp_exceptional_job_items (
    rampId VARCHAR(45) NOT NULL,
    flowId VARCHAR(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ramp_items (
  rampId VARCHAR(45) NOT NULL,
  dependency VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS validated_dependencies (
  file_name         VARCHAR(128),
  file_sha1         CHAR(40),
